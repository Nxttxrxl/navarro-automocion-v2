                                ...
                                <div className="grid grid-cols-2 lg:grid-cols-3 gap-4">
                                    ...
                                    <div className="flex items-center gap-3 p-3 bg-slate-50 rounded-lg">
                                        ...
                                        <div>
                                            ...
                                            <div className="font-semibold text-slate-900">{car.transmision || 'Manual'}</div>
                                        </div>
                                    </div>
                            ...
                            <div className="bg-gradient-to-br from-blue-50 to-slate-50 rounded-xl p-6 border border-blue-100 shadow-sm">
                                ...
                                <ul className="space-y-3">
                                    ...
                                    <li className="flex items-start gap-3">
                                        <span className="material-symbols-outlined text-green-600 text-xl mt-0.5">check_circle</span>
                                        <div>
                                            <div className="font-semibold text-slate-900 text-sm">Transparencia Total</div>
                                            <div className="text-xs text-slate-600">Sin costes ocultos ni sorpresas</div>
                                        </div>
                                    </li>
                                </ul>
                            </div>
